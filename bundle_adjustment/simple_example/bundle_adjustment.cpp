...
int main(int argc, char** argv) {
  ...
  // Load JSON Data
  // json data = ba::read_json("noisy-calibrations-and-world-points.json");
  json data = ba::read_json("bare_minimal.json");
  ...
  ba::json_write(points, cameras, output_data, "answer_bare_minimal.json");
