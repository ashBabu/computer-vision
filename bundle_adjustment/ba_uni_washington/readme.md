The data is taken from [here](https://grail.cs.washington.edu/projects/bal/), specifically the [Dubrovnik](https://grail.cs.washington.edu/projects/bal/dubrovnik.html)
